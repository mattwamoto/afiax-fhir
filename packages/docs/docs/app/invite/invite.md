...
This guide explains how to invite another user to your Afiax project.

import adminUsersPage from './admin-users-page.png'

<img alt="Admin Users Page" src={adminUsersPage} style={{maxWidth: "75%"}}/>

1. Open the Afiax Admin App in your browser: `https://app.afiax.africa/`. If you do not have an account yet, see the registration flow in your environment.
2. Navigate to the [Project Admin](https://app.afiax.africa/admin/project) page at [https://app.afiax.africa/admin/project](https://app.afiax.africa/admin/project).
...
8. By default, the platform will send a welcome email to the new user. You can toggle the "Send email" checkbox if you do not want to send an email. You may also be interested in [Custom Emails](/docs/user-management/custom-emails).
