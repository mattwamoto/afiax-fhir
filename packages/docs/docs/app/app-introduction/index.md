...
The Afiax Admin App is a user-facing web application available at [https://app.afiax.africa/](https://app.afiax.africa/) and is intended for developers, project administrators, and implementation teams. This administrative app is built from the underlying [React](/docs/react) component library in this repository, so many of these views and behaviors can also be embedded into your own applications.

This guide covers the basic functionality of the Afiax Admin App.

## Homepage

![App Homepage](./app-homepage.png)

When you first log in to the Afiax Admin App, you'll see the page shown above. This home page consists of a few primary components:

- **[Search Control](#search-control)** - Displays a list of the currently selected resource type.
- **[Sidebar](#sidebar)** - Used to select the current resource type and quickly navigate to different parts of the Afiax Admin App.
...
- **New:** Create a new resource of the selected type. This will open a form to specify the fields of the newly created resource, with the <span style={{color:"red"}}>\*</span> character indicating required fields.
  :::note
  This form is an instance of the `ResourceForm` React component and can be embedded into your own applications.
  :::
...
- **Bulk:** Execute a [Bot](/docs/bots) on all selected rows.

This search control is also encapsulated as a reusable React component and can be embedded into your own applications.

:::caution Caution
For performance reasons, the total resource count displayed in the Afiax Admin App is an **estimated count**, not an exact count. You can read more about fetching resource counts [here](/docs/search/paginated-search#getting-the-total-number-of-results-with-_total)
:::

## Sidebar

The sidebar is used to quickly navigate to different parts of the Afiax Admin App.

You can show or hide the sidebar by clicking the Afiax mark in the top-left corner.
...
- [Project Admin page](https://app.afiax.africa/admin/project)
...
- [Security Settings](https://app.afiax.africa/security)
...
"Account Settings" can be used to navigate to the user's profile resource page.
